...
//	private bool bMostRecentCheck = false;
	...
	public float 	opt_RoadDefinition = 1f;			//Done.
	...
	public float 	opt_MatchHeightsDistance = 3f;
	public float 	opt_ClearDetailsDistance = 3f;
	public float 	opt_ClearDetailsDistanceHeight = 5f;
	public float 	opt_ClearTreesDistance = 30f;
	public float 	opt_ClearTreesDistanceHeight = 3f;
	...
	public float	opt_MagnitudeThreshold = 20f;
